## ros2_kortex (jazzy) - 0.2.6-1

The packages in the `ros2_kortex` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy ros2_kortex` on `Wed, 07 Jan 2026 22:25:14 -0000`
...
## ros2_kortex (rolling) - 0.2.5-1

The packages in the `ros2_kortex` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --new-track --rosdistro rolling --track rolling ros2_kortex` on `Tue, 16 Dec 2025 20:42:20 -0000`
...
## ros2_kortex (humble) - 0.2.2-1

The packages in the `ros2_kortex` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble ros2_kortex` on `Wed, 09 Aug 2023 15:02:02 -0000`
...
## ros2_kortex (rolling) - 0.2.2-1

The packages in the `ros2_kortex` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling ros2_kortex` on `Wed, 09 Aug 2023 14:56:50 -0000`
...
## ros2_kortex (humble) - 0.2.1-1

The packages in the `ros2_kortex` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble ros2_kortex` on `Wed, 26 Jul 2023 20:36:38 -0000`
